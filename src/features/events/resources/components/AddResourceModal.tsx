...
import { createRecursoEnlace, createRecursoArchivo } from '../../services/EventResourcesService';
...
export default function AddResourceModal({ open, onClose, eventoId, onResourceAdded }: AddResourceModalProps) {
