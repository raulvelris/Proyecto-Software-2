      ...
      <aside className="space-y-5">
        <div className="card p-5">
          <ul className="text-sm space-y-3">
            <li className="flex items-center gap-2"><i className="bi bi-calendar-event" /> {new Date(event.startDate).toLocaleDateString()}</li>
            <li className="flex items-center gap-2"><i className="bi bi-clock" /> {new Date(event.startDate).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })} – {new Date(event.endDate).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}</li>
